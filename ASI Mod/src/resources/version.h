...
// Core name & version
#define FIX_NAME "MGS2-Upscaled-UI-Textures"
#define PRIMARY_REPO_URL "https://github.com/ShizCalev/MGS2-Upscaled-UI-Textures"
#define FALLBACK_REPO_URL "https://gitlab.com/ShizCalev/MGS2-Upscaled-UI-Textures"
